...
| `external-wos` | `external-wos` | configured Scopus Source List CSV | `data/processed_data/web_of_science.csv` | `records` is normalized journal ISSN rows in the output | Skips complete output; legacy command/output name retained |
